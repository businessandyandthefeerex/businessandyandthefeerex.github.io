...
To do:
 ...
 - need to make sure the map csv is created on commit fresh every time, attempt in .git/hooks folder, further testing required, trying with githooks extension
