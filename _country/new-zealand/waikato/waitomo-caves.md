...
{% assign posts = site.posts | where: "country", "New Zealand" | where: "region", "Waikato" | where: "city", "Waitomo Caves" %}
...
{% if group.name != "" %}
#### [{{ group.name }}](/country/new-zealand/waikato/{{ group.name | downcase | slugify }}/){: style="color: var(--heading-color);"}
{% else %}
#### Unspecified suburb
{% endif %}
