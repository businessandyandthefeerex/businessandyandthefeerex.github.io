...
{% assign posts = site.posts | where: "country", "New Zealand" | where: "region", "Southland" | where: "city", "Bluff" %}
...
{% if group.name != "" %}
#### [{{ group.name }}](/country/new-zealand/southland/{{ group.name | downcase | slugify }}/){: style="color: var(--heading-color);"}
{% else %}
#### Unspecified suburb
{% endif %}
