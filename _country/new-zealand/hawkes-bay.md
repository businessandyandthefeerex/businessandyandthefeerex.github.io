---
layout: page
title: Hawkes Bay, New Zealand
country: New Zealand
region: Hawkes Bay
permalink: /country/new-zealand/hawkes-bay/
---
[↑ Go to New Zealand regions](/country/new-zealand/)

{% assign posts = site.posts | where: "region", "Hawkes Bay" | where: "country", "New Zealand" %}
...
{% if city_group.name != "" %}
### [{{ city_group.name }}](/country/new-zealand/hawkes-bay/{{ city_slug }}/){: style="color: var(--heading-color);"}
{% else %}
### Unspecified city
{% endif %}
...
{% if group.name != "" %}
#### [{{ group.name }}](/country/new-zealand/hawkes-bay/{{ suburb_slug }}/){: style="color: var(--heading-color);"}
{% else %}
#### Unspecified suburb
{% endif %}
