...
{% if city_group.name != "" %}
### [{{ city_group.name }}](/country/new-zealand/waikato/{{ city_slug }}/){: style="color: var(--heading-color);"}
{% else %}
### Unspecified city
{% endif %}
...
{% if group.name != "" %}
#### [{{ group.name }}](/country/new-zealand/waikato/{{ suburb_slug }}/){: style="color: var(--heading-color);"}
{% else %}
#### Unspecified suburb
{% endif %}
